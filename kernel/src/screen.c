...
static ca mapaClon [VIDEO_COLS][VIDEO_COLS];
...
void game_guardar_mapa()
{
	int posX;
	int posY;
	for(posY=0;posY<VIDEO_COLS;posY++)
	{
		for(posX=0;posX<VIDEO_COLS;posX++)
		{
		mapaClon[posX][posY].c= p[posX][posY].c;
		mapaClon[posX][posY].a= p[posX][posY].a; 
		}
	}
}

void game_restaurar_mapa()
{
	int posX;
	int posY;
	for(posY=0;posY<VIDEO_COLS;posY++)
	{
		for(posX=0;posX<VIDEO_COLS;posX++)
		{
		p[posX][posY].c=mapaClon[posX][posY].c;
		p[posX][posY].a =mapaClon[posX][posY].a; 
		}
	}
}
...
void screen_clean(){
    screen_pintar_rect(' ', C_BG_LIGHT_GREY | C_FG_WHITE, 0, 0, VIDEO_FILS, VIDEO_COLS);
    screen_pintar_rect(' ', C_BG_RED   | C_FG_WHITE, 45, 33, 5, 7);
    screen_pintar_rect(' ', C_BG_BLUE  | C_FG_WHITE, 45, 40, 5, 7);	
}

void printAux(unsigned char scanCode){
        
	switch(scanCode){
		case 0x10: print("Q",79,0,C_BW); break;
		case 0x11: print("W",79,0,C_BW); break;
		case 0x12: print("E",79,0,C_BW); break;
		case 0x1e: print("A",79,0,C_BW); break;
		case 0x1f: print("S",79,0,C_BW); break;
		case 0x20: print("D",79,0,C_BW); break;
		case 0x2c: print("Z",79,0,C_BW); break;
		case 0x2d: print("X",79,0,C_BW); break;
		case 0x2e: print("C",79,0,C_BW); break;

		case 0x90: print("Q",79,0,C_BW); break;
		case 0x91: print("W",79,0,C_BW); break;
		case 0x92: print("E",79,0,C_BW); break;
		case 0x9e: print("A",79,0,C_BW); break;
		case 0x9f: print("S",79,0,C_BW); break;
		case 0xA0: print("D",79,0,C_BW); break;
		case 0xAc: print("Z",79,0,C_BW); break;
		case 0xAd: print("X",79,0,C_BW); break;
		case 0xAe: print("C",79,0,C_BW); break;

		case 0x16: print("U",79,0,C_BW); break;
		case 0x17: print("I",79,0,C_BW); break;
		case 0x18: print("O",79,0,C_BW); break;
		case 0x24: print("J",79,0,C_BW); break;
		case 0x25: print("K",79,0,C_BW); break;
		case 0x26: print("L",79,0,C_BW); break;
		case 0x30: print("B",79,0,C_BW); break;
		case 0x31: print("N",79,0,C_BW); break;
		case 0x32: print("M",79,0,C_BW); break;

		case 0x96: print("U",79,0,C_BW); break;
		case 0x97: print("I",79,0,C_BW); break;
		case 0x98: print("O",79,0,C_BW); break;
		case 0xa4: print("J",79,0,C_BW); break;
		case 0xa5: print("K",79,0,C_BW); break;
		case 0xa6: print("L",79,0,C_BW); break;
		case 0xb0: print("B",79,0,C_BW); break;
		case 0xb1: print("N",79,0,C_BW); break;
		case 0xb2: print("M",79,0,C_BW); break;
		
		case 0x15: print("Y",79,0,C_BW); break;
    }
}
